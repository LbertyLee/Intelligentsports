...
public class TrainingTeamServiceImpl implements TrainingTeamService {
     ...
     */
    @Override
    public int addTrainingTeam(TrainingTeamBo teacherTrainingTeamBo) {
        // 将TeacherTrainingTeamBo对象复制到TeacherTrainingTeam对象
        TrainingTeam teacherTrainingTeam = new TrainingTeam().setTeamName(teacherTrainingTeamBo.getTeamName());
     ...
     */
    @Override
    public int updateTrainingTeam(TrainingTeamBo teacherTrainingTeamBo) {
        // 复制TeacherTrainingTeamBo对象到TeacherTrainingTeam对象，以进行更新
        TrainingTeam teacherTrainingTeam = BeanUtil.copyProperties(teacherTrainingTeamBo, TrainingTeam.class);
        if (log.isInfoEnabled()){
     ...
     */
    @Override
    public TableDataInfo<TrainingTeamVo> selectPageTeacherTrainingTeamList(TrainingTeamBo teacherTrainingTeamBo,
                                                                           PageQuery pageQuery) {
        // 调用TeacherTrainingTeamMapper的selectPageTeacherTrainingTeamList方法进行分页查询
        Page<TrainingTeamVo> page=teacherTrainingTeamMapper.selectPageTeacherTrainingTeamList(
     ...
     */
    @Override
    public boolean bindStudent(TrainingTeamStudentBo teacherTrainingTeamBindStudentBo) {
        ...
        List<TrainingTeamStudent> teacherTrainingTeamStudentList = studentId.stream().map(id -> {
            return new TrainingTeamStudent().setStudentId(id).setTrainingTeamId(trainingTeamId);
        }).toList();
    ...
    @Override
    public List<TrainingTeamVo> list(TrainingTeamBo teacherTrainingTeamBo) {
        Wrapper<TrainingTeam> trainingTeamWrapper = this.buildQueryWrapper(teacherTrainingTeamBo);
        return teacherTrainingTeamMapper.selectVoList(trainingTeamWrapper, TrainingTeamVo.class);
    }
     ...
     */
    private Wrapper<TrainingTeam> buildQueryWrapper(TrainingTeamBo teacherTrainingTeamBo) {
        // 创建一个空的查询Wrapper
        QueryWrapper<TrainingTeam> wrapper = Wrappers.query();
